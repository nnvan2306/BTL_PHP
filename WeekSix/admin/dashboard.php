        ...
        <aside id="default-sidebar"
            ...
            <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                <ul class="space-y-2 font-medium">
                    ...
                    <hr>
                    <li
                        class="<?= basename($_GET['route']) == 'themProductSix.php' ? 'bg-[#ccc] rounded-lg text-[#fff]' : '' ?>">
                    ...
                    <li
                        class="<?= basename($_GET['route']) == 'listSuaSix.php' ? 'bg-[#ccc] rounded-lg text-[#fff]' : '' ?>">
                    ...
                    <li
                        ...
                        <a href="dashboard.php?route=listKhachHang.php"
                            ...
                            <span class="flex-1 ms-3 whitespace-nowrap">Danh Sách Khách Hàng</span>
                        </a>
                    </li>
                    <hr>
                    <li>
